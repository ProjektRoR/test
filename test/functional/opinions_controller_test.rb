...
class OpinionsControllerTest < ActionController::TestCase
  ...
  test "should create opinion" do
    assert_difference('Opinion.count') do
      post :create, opinion: { book_id: @opinion.book_id, opinion: @opinion.opinion, user_id: @opinion.user_id }
    end
  ...
  test "should update opinion" do
    put :update, id: @opinion, opinion: { book_id: @opinion.book_id, opinion: @opinion.opinion, user_id: @opinion.user_id }
    assert_redirected_to opinion_path(assigns(:opinion))
  end
